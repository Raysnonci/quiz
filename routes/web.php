...
/*
Kegunaan baris 18-19 adalah untuk...
*/
use Illuminate\Support\Facades\Route;
use Illuminate\Support\Facades\Auth;

/*
Kegunaan baris 24-28 adalah untuk...
*/
Auth::routes([
    'register'=>false,
    'reset' => false,
...
Route::get('user/quiz/{quizId}', 'ExamController@getQuizQuestion')->middleware('auth');
...
Route::group(['middleware'=>'isAdmin'], function()
{
    ...
    Route::get('exam/assign', 'ExamController@create')->name('assign');
    Route::post('exam/assign', 'ExamController@assignExam')->name('assignPost');
